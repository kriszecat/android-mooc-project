...
import com.nicecat.leisure.data.base.BaseContentProvider;
import com.nicecat.leisure.data.city.CityColumns;

public class LeisureProvider extends BaseContentProvider {
    private static final String TAG = LeisureProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "com.nicecat.leisure.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return LeisureSQLiteOpenHelper.getInstance(getContext());
    }
